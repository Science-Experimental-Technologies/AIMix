...
// and break recursive loops between aimix instances connected to each other.
const INTERNAL_MODELS_FETCH_HEADER = "x-aimix-internal-models-fetch";
...
export async function buildModelsList(kindFilter, options = {}) {
  ...
  // aimix instance's fetchCompatibleModelIds — skip dynamic fetch to break
...
export async function GET(request) {
  try {
    // Detect cross-instance recursive /models fetch (another aimix fetching our /models)
