...
// Build TOML config for AIMix (openai provider mode)
const buildAIMixConfig = (baseUrl, apiKey, model) => {
...
// Detect AIMix by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildAIMixConfig(baseUrl, apiKey || "sk_aimix", model);
