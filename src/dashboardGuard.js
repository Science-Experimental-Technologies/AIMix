...
const CLI_TOKEN_HEADER = "x-aimix-cli-token";
const CLI_TOKEN_SALT = "aimix-cli-auth";
...
function isLoopbackPeer(request) {
  if (hasTrustedPeerHeaders(request)) {
    return isLoopbackHostname(request.headers.get("x-aimix-real-ip"));
  }
...
export function isLocalRequest(request) {
  ...
  if (request.headers.get("x-aimix-via-proxy")) return false;
