...
// Distribution links are local-only until a public AIMix repository/service is configured.
export const GITHUB_CONFIG = {
  changelogUrl: "/api/aimix/changelog",
  donateUrl: "/api/aimix/support",
};

// Updater configuration
export const UPDATER_CONFIG = {
  npmPackageName: "aimix",
  installCmd: "npm i -g aimix",
  installCmdLatest: "npm i -g aimix@latest --prefer-online",
