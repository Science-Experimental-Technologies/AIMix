/**
 * `aimix xai video` — generate a Grok Imagine video through the local
 * aimix gateway and save the result as an MP4 file.
 *
...
const HELP = `
Usage: aimix xai video --prompt "..." [options]

Generate a Grok Imagine video via your local aimix gateway
...
Options:
  ...
  --api-key <key>         aimix API key (or env NINE_ROUTER_API_KEY)
...
async function run(argv) {
  ...
  try {
    ...
    const connectionId = create.headers["x-aimix-connection-id"] || null;
