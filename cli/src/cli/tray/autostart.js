...
const APP_LABEL = "com.aimix.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when aimix is currently
 ...
 * SIGTERM to the running process. When the running aimix cli.js was itself
...
<dict>
    ...
    <string>/tmp/aimix.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/aimix.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `aimix.cmd` lookup that depended on the npm prefix path.
