...
The same matrix applies to aimix's virtual `-review` variants because they
...
- Adding Codex Ultra's multi-agent orchestration behavior inside aimix;
  aimix only forwards the catalog-advertised reasoning override.
