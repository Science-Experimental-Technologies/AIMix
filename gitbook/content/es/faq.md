...
Preguntas comunes sobre AIMix.

---

## ¿Qué es AIMix?

**AIMix es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**AIMix usa una estrategia de precios de 3 niveles:**
...
**Sí, AIMix en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de AIMix.**
...
**AIMix rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿Puedo auto-hospedar AIMix?

**¡Sí! AIMix soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.aimix`)
...
**Sí, AIMix prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.aimix` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de AIMix
...
**Cambios disruptivos:**
- Respalda `~/.aimix` antes de actualizaciones mayores
...
3. **Enviar código:**
   ```bash
   # Fork del repo
   git clone https://github.com/YOUR_USERNAME/aimix.git
   cd aimix
