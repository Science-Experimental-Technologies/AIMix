...
Problemas comunes y soluciones al usar AIMix.
...
1. **Refresh automático (por defecto):**
   AIMix refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
1. **Verifica si AIMix está ejecutándose:**
   ```bash
   # Verifica el proceso
   ps aux | grep aimix
