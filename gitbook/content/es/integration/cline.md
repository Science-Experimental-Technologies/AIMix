...
Integra AIMix con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de AIMix.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Cline instalada desde el marketplace de VSCode
- AIMix ejecutándose localmente o endpoint en la nube configurado
...
Establece la URL base a tu endpoint de AIMix:
...
**Para AIMix en la nube:**
```
http://localhost:20128
```

**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de AIMix
...
4. Cline usará AIMix para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando AIMix
...
3. Obtén explicaciones potenciadas por IA a través de AIMix

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará AIMix para entender el contexto y hacer cambios
...
1. Verifica que AIMix esté corriendo: `curl http://localhost:20128/health`
...
2. Verifica que tu instancia de AIMix esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de AIMix para cualquier error

## Configuración avanzada

### Usar endpoint en la nube

Para usar el endpoint en la nube de AIMix en lugar de localhost:

1. En la configuración de Cline, establece Base URL a: `http://localhost:20128`
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de AIMix
...
## Integración con características de AIMix

### Enrutamiento de modelos

AIMix enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, AIMix automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de AIMix:
