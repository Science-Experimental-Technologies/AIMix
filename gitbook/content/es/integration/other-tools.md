...
AIMix es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

AIMix proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a AIMix usando estas configuraciones:

**AIMix local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de AIMix (cc/*, cx/*, glm/*, etc.)
```
...
**Problema:** No se puede conectar a AIMix
```bash
# Verifica si AIMix está corriendo
...
**Solución:**
- Verifica que AIMix esté corriendo
...
- Verifica la conexión de red a AIMix
...
- [Referencia de API](../getting-started/quick-start.md)
