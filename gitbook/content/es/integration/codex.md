...
Integra AIMix con OpenAI Codex CLI para enrutar tus solicitudes de la API de OpenAI a través del sistema de enrutamiento inteligente de AIMix.
...
AIMix proporciona los siguientes modelos de Codex:
...
1. Verifica que tu API key sea correcta en el dashboard de AIMix
...
1. Verifica que el nombre del modelo coincida con tu configuración de AIMix
2. Verifica que la conexión del proveedor de OpenAI esté activa en el dashboard de AIMix
...
Asegúrate de haber configurado tu API key en el dashboard en la nube de AIMix.
