...
Guía detallada de instalación de AIMix con consejos de solución de problemas.
...
Instala AIMix globalmente para usar desde cualquier lugar:
...
- ✅ Comando simple: `aimix`
- ✅ Auto-actualizaciones con `npm update -g aimix`
...
3. Se crea el directorio de datos en `~/.aimix`
...
**Error:**
```
Error: EACCES: permission denied, mkdir '/usr/local/lib/node_modules/aimix'
```
...
**Problema:** AIMix usa demasiada RAM
...
```bash
docker pull aimix/aimix:latest

docker run -d \
  -p 20128:20128 \
  -e JWT_SECRET="your-secure-secret" \
  -e INITIAL_PASSWORD="your-password" \
  -v aimix-data:/root/.aimix \
  --name aimix \
  aimix/aimix:latest
```
...
nano ~/.bashrc  # o ~/.zshrc
# Eliminar exports relacionados con aimix
```
...
- [Guía para empezar](../index.md) - Conecta proveedores y comienza a codificar
