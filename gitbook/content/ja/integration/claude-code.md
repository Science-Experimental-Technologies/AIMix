...
AIMixをClaude Code CLIと統合し、AnthropicのAPIリクエストをAIMixのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはAIMixモデルにマッピングされる以下のモデルエイリアスをサポート:
