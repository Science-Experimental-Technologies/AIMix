...
AIMixをOpenAI Codex CLIと統合し、OpenAI APIリクエストをAIMixのインテリジェントルーティングシステム経由でルーティングします。
...
1. モデル名がAIMix設定と一致するか確認
2. AIMixダッシュボードでOpenAIプロバイダー接続がアクティブか確認
3. 接続されたプロバイダーでモデルが利用可能か確認

## クラウドエンドポイント

localhostの代わりにAIMixクラウドエンドポイントを使用するには:

```bash
export OPENAI_BASE_URL="http://localhost:20128"
```

AIMixクラウドダッシュボードでAPIキーが設定されていることを確認してください。
