...
Triển khai AIMix trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.aimix` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/aimix`:
...
# If NOT using reverse proxy, allow AIMix ports
