...
Hướng dẫn cài đặt chi tiết cho AIMix với mẹo troubleshooting.
...
Cài AIMix toàn cục để dùng ở bất kỳ đâu:
...
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `aimix`
- ✅ Auto-update với `npm update -g aimix`
...
3. Data directory được tạo tại `~/.aimix`
...
**Vấn đề:** AIMix dùng quá nhiều RAM
...
- [Hướng dẫn Bắt đầu](../index.md) - Kết nối provider và bắt đầu code
