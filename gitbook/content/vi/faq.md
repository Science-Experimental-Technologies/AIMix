...
Những câu hỏi phổ biến về AIMix.

---

## AIMix là gì?

**AIMix là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**AIMix dùng chiến lược pricing 3 tầng:**
...
## AIMix có miễn phí không?

**Có, AIMix hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của AIMix.**
...
**AIMix theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host AIMix không?

**Có! AIMix hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.aimix`)
...
**Có, AIMix ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.aimix` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server AIMix
...
**Breaking changes:**
- Backup `~/.aimix` trước khi update lớn
