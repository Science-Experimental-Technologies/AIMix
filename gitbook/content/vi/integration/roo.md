...
Tích hợp AIMix với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model AIMix có sẵn:
...
### Connection Failed
- Xác minh AIMix đang chạy: `curl http://localhost:20128/health`
