...
Tích hợp AIMix với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- AIMix API key từ [dashboard](http://localhost:20128/dashboard)
- AIMix đang chạy (cục bộ hoặc cloud)
...
- Kiểm tra AIMix đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến AIMix
