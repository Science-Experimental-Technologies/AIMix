...
Integrate AIMix with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- AIMix API key from [dashboard](http://localhost:20128/dashboard)
- AIMix running (local or cloud)
...
### 2. Add AIMix Model Configuration
...
3. Choose your preferred AIMix model
...
- Check network latency to AIMix
