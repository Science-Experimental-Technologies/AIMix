...
Integrate AIMix with OpenAI Codex CLI to route your OpenAI API requests through AIMix's intelligent routing system.
...
AIMix provides the following Codex models:
...
1. Verify your API key is correct in AIMix dashboard
...
2. Check that the OpenAI provider connection is active in AIMix dashboard
