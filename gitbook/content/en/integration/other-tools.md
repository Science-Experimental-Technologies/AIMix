...
AIMix is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

AIMix provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to AIMix using these settings:

**Local AIMix:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any AIMix model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to AIMix
```bash
...
- Check network connection to AIMix
