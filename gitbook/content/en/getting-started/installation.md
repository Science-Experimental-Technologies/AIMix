...
Detailed installation guide for AIMix with troubleshooting tips.
...
Install AIMix globally to use from anywhere:
...
- ✅ Simple command: `aimix`
- ✅ Auto-updates with `npm update -g aimix`
...
3. Data directory created at `~/.aimix`
...
**Issue:** AIMix using too much RAM
...
- [Getting Started Guide](../index.md) - Connect providers and start coding
