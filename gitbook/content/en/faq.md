...
Common questions about AIMix.

---

## What is AIMix?

**AIMix is an AI model router that maximizes your subscription value and minimizes costs.**
...
3. **Free tier** - Emergency backup with availability varies models
...
**AIMix uses a 3-tier pricing strategy:**
...
**Yes, AIMix itself is 100% free and open source.**
...
**Yes! This is AIMix's core feature.**
...
**AIMix tracks quota in real-time for all providers:**
...
## Can I self-host AIMix?

**Yes! AIMix supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.aimix`)
...
**Yes, AIMix prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.aimix` (or custom `DATA_DIR`)
- No data sent to AIMix servers
...
**Breaking changes:**
- Backup `~/.aimix` before major updates
