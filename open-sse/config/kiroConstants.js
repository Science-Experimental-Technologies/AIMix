 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what aimix needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a aimix
 ...
 * The suffix is a aimix request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a aimix synthetic agentic variant.
...
/**
 * Detect whether a model id is a aimix synthetic thinking variant
...
/**
 * Resolve a aimix model id to the real upstream Kiro model id, plus flags
