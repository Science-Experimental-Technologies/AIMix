 ...
 * API. They are aimix fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic aimix variant set for a single upstream Kiro model.
 *
 ...
 * into aimix variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
